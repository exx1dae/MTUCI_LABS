...
class Calculator(QWidget):
    def __init__(self):
        ...
        self.vbox.addLayout(self.hbox_ops)
        ...
        self.hbox_ops.addWidget(self.b_zap)

        self.b_0 = QPushButton("0", self)
        self.hbox_ops.addWidget(self.b_0)
        ...
        self.b_umnozh = QPushButton("*", self)
        self.hbox_third.addWidget(self.b_umnozh)

        self.b_delete = QPushButton("/", self)
        self.hbox_ops.addWidget(self.b_delete)

        self.b_chist = QPushButton("C", self)
        self.hbox_ops.addWidget(self.b_chist)
        ...
        self.b_umnozh.clicked.connect(lambda: self._operation("*"))
        self.b_delete.clicked.connect(lambda: self._operation("/"))
        self.b_chist.clicked.connect(lambda: self._operation("C"))
